...
<html lang="en" dir="ltr">
  ...
  <section class="py-5 text-center container">
    <?php if ($data) { ?>
      ...
      <br>
      <p class="h2"><?php echo (zaal_location($data['zaal_khoroo'])['city_name']); ?> /
	  <?php
			$location = zaal_location($data['zaal_khoroo']);
			if ($location) {
				?>
				<p class="h2"><?php echo $location['city_name']; ?> / <?php echo $location['district_name']; ?> / <?php echo $location['khoroo_name']; ?></p>
				<?php
			} else {
